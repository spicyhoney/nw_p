...
第一次閱讀本專案時，先看[專案白話指南](project-guide.md)；本頁集中說明較完整的
AWS 角色、adapter 邊界與未來部署方式。未完成工作以 [TASKS](../TASKS.md) 為準。
...
PR #13 最終本機完整結果為 `105 passed, 15 skipped, 43 subtests passed`，未提供
測試資料庫的 skip 已由 PostgreSQL CI 補跑。完整測試結果以
