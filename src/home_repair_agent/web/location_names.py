"""Controlled Taiwan administrative district names used for text provenance checks."""

# Generated from data/reference/taiwan_admin_areas.json (NLSC snapshot). Keep this
# package-local so installed wheels do not depend on repository-relative data files.
TAIWAN_DISTRICT_NAMES = frozenset(
    """
...
南竿鄉 北竿鄉 莒光鄉 東引鄉
""".split()  # noqa: SIM905 - compact, reviewable copy of the controlled snapshot
)
